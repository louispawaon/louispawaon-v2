...
<section class="space-y-4 sm:space-y-6">
	...
	>
		...
		<span class="inline-flex h-[1em] w-[1em] translate-y-[0.05em] select-none align-middle" aria-hidden="true">
	...
	<p class="text-lg font-light italic text-muted-foreground sm:text-xl md:text-[30px]">
		{tagline}
	</p>
</section>
